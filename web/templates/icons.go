...
// IconSVG returns the inner <path>/<rect>/etc body of a 24x24 Lucide icon
// for the given key, or empty if unknown. Wrap it in <svg width="..." height=".."
// viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
// stroke-linecap="round" stroke-linejoin="round"> in the template.
//
// Source: github.com/lucide-icons/lucide (ISC license). We embed only the path
// data, not the SVG header, so we control sizing/coloring per call site.
func IconSVG(key string) string {
	...
	case "wine":
		return `<path d="M8 22h8"/><path d="M7 10h10"/><path d="M12 15v7"/><path d="M12 15a5 5 0 0 0 5-5c0-2-.5-4-2-8H9c-1.5 4-2 6-2 8a5 5 0 0 0 5 5Z"/>`
	case "packages":
		return `<path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="M3.3 7 12 12l8.7-5"/><path d="M12 22V12"/>`
	case "server-admin":
	...
	case "preferences":
		return `<circle cx="18" cy="15" r="3"/><circle cx="9" cy="7" r="4"/><path d="M10 15H6a4 4 0 0 0-4 4v2"/><path d="m21.7 16.4-.9-.3"/><path d="m15.2 13.9-.9-.3"/><path d="m16.6 18.7.3-.9"/><path d="m19.1 12.2.3-.9"/><path d="m19.6 18.7-.4-1"/><path d="m16.8 12.3-.4-1"/><path d="m14.3 16.6 1-.4"/><path d="m20.7 13.8 1-.4"/>`
	case "search":
		return `<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>`
	case "plus":
		return `<path d="M5 12h14"/><path d="M12 5v14"/>`
	case "settings":
		// Lucide "sliders-horizontal" — a clean column-picker affordance.
		return `<line x1="21" x2="14" y1="4" y2="4"/><line x1="10" x2="3" y1="4" y2="4"/><line x1="21" x2="12" y1="12" y2="12"/><line x1="8" x2="3" y1="12" y2="12"/><line x1="21" x2="16" y1="20" y2="20"/><line x1="12" x2="3" y1="20" y2="20"/><line x1="14" x2="14" y1="2" y2="6"/><line x1="8" x2="8" y1="10" y2="14"/><line x1="16" x2="16" y1="18" y2="22"/>`
	case "inbox":
	...
	// --- Target picker icons ----------------------------------------
	// One per TargetKind. Visually distinct so a glance at a row's
	// leading icon tells the admin "this is a computer / a user / a
	// group …" without reading the chip.
	...
	case "target-computer-group":
		// Lucide "server" stack — implies "many computers"
	...
	case "target-user-group":
		// Lucide "users" — multiple silhouettes
		return `<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>`
	case "target-config-group":
		// Lucide "layers" — one CG composing on top of others
		return `<path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z"/><path d="m22 17.65-9.17 4.16a2 2 0 0 1-1.66 0L2 17.65"/><path d="m22 12.65-9.17 4.16a2 2 0 0 1-1.66 0L2 12.65"/>`
	case "target-regex":
		// Lucide "regex"
		return `<path d="M17 3v10"/><path d="m12.67 5.5 8.66 5"/><path d="m12.67 10.5 8.66-5"/><path d="M9 17a2 2 0 1 0 4 0 2 2 0 0 0-4 0Z"/>`

	// --- Module / source / picker icons -----------------------------
	case "x":
		// Lucide "x" — close dialog.
		return `<path d="M18 6 6 18"/><path d="m6 6 12 12"/>`
	case "trash":
		// Lucide "trash-2"
		return `<path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/>`
	case "package":
		// Lucide "package" — distinct from "packages" (already mapped to box-3d).
		return `<path d="M16.5 9.4 7.55 4.24"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/>`
	case "building":
		// Lucide "building" — tenant org icon.
	...
	case "globe":
		// Lucide "globe" — external / imported registry.
