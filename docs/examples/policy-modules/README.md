...
> Spec-by-example for the Policy Module format defined in `docs/ARCHITECTURE_DECISIONS.md` ADR-006. **Not wired into the agent yet** — this directory exists only as a reference shape against which the runtime will be tested in Phase 2.
