...
| `kanidm` | The identity provider Pluris uses by default — replaces what AD does for users, groups, and authentication. | ≈ AD DS (Active Directory Domain Services), without the SMB/Kerberos legacy. |
