...
type Querier interface {
	...
	CacheVersionManifest(ctx context.Context, arg CacheVersionManifestParams) error
	...
	CreateVersionConditionGuarded(ctx context.Context, arg CreateVersionConditionGuardedParams) (ModuleVersionCondition, error)
	...
	DeleteCustomActionsForVersion(ctx context.Context, versionID int64) error
	DeleteCustomPolicy(ctx context.Context, id int64) error
	DeleteCustomScriptsForVersion(ctx context.Context, versionID int64) error
	...
	DeleteDraftModuleVersion(ctx context.Context, id int64) (int64, error)
	...
	DeleteModuleActionGuarded(ctx context.Context, arg DeleteModuleActionGuardedParams) (int64, error)
	...
	DeleteModuleScriptGuarded(ctx context.Context, arg DeleteModuleScriptGuardedParams) (int64, error)
	...
	DeleteVersionConditionGuarded(ctx context.Context, arg DeleteVersionConditionGuardedParams) (int64, error)
	...
	GetAssetForDeletion(ctx context.Context, arg GetAssetForDeletionParams) (Asset, error)
	...
	GetConfigurationGroupIncludingDeleted(ctx context.Context, id int64) (ConfigurationGroup, error)
	...
	GetDependencyGroupIncludingDeleted(ctx context.Context, id int64) (DependencyGroup, error)
	GetGroup(ctx context.Context, id int64) (Group, error)
	GetGroupBySlug(ctx context.Context, arg GetGroupBySlugParams) (Group, error)
	GetGroupIncludingDeleted(ctx context.Context, id int64) (Group, error)
	...
	GetIdentityIncludingDeleted(ctx context.Context, id int64) (Identity, error)
	...
	GetPolicyModuleByURNIncludingDeleted(ctx context.Context, moduleUrn string) (PolicyModule, error)
	...
	GetRetentionSetting(ctx context.Context, entityKind string) (RetentionSetting, error)
	GetRole(ctx context.Context, id int64) (Role, error)
	GetRoleBySlug(ctx context.Context, arg GetRoleBySlugParams) (Role, error)
	GetScriptByName(ctx context.Context, arg GetScriptByNameParams) (PolicyModuleScript, error)
	...
	IsAssetInGroup(ctx context.Context, arg IsAssetInGroupParams) (bool, error)
	IsIdentityInGroup(ctx context.Context, arg IsIdentityInGroupParams) (bool, error)
	ListActionsForVersion(ctx context.Context, versionID int64) ([]PolicyModuleAction, error)
	...
	ListDeletedAssetsBySubtype(ctx context.Context, arg ListDeletedAssetsBySubtypeParams) ([]Asset, error)
	ListDeletedConfigurationGroupsByTenant(ctx context.Context, arg ListDeletedConfigurationGroupsByTenantParams) ([]ConfigurationGroup, error)
	ListDeletedDependencyGroupsByTenant(ctx context.Context, tenantID int64) ([]DependencyGroup, error)
	ListDeletedGroupsByTenant(ctx context.Context, tenantID int64) ([]Group, error)
	ListDeletedIdentitiesByTenant(ctx context.Context, arg ListDeletedIdentitiesByTenantParams) ([]Identity, error)
	ListDeletedIdentitiesByTenantWithSite(ctx context.Context, arg ListDeletedIdentitiesByTenantWithSiteParams) ([]ListDeletedIdentitiesByTenantWithSiteRow, error)
	ListDeletedVisibleModules(ctx context.Context, tenantID sql.NullInt64) ([]PolicyModule, error)
	...
	ListExpiredAssets(ctx context.Context, cutoff interface{}) ([]Asset, error)
	ListExpiredConfigurationGroups(ctx context.Context, cutoff interface{}) ([]ConfigurationGroup, error)
	ListExpiredDependencyGroups(ctx context.Context, cutoff interface{}) ([]DependencyGroup, error)
	ListExpiredGroups(ctx context.Context, cutoff interface{}) ([]Group, error)
	ListExpiredIdentities(ctx context.Context, cutoff interface{}) ([]Identity, error)
	ListExpiredPolicyModules(ctx context.Context, cutoff interface{}) ([]PolicyModule, error)
	...
	// ============================================================================
	ListVersionConditions(ctx context.Context, versionID int64) ([]ModuleVersionCondition, error)
	...
	MaxVersionConditionSeq(ctx context.Context, versionID int64) (interface{}, error)
	...
	RenameModuleScriptGuarded(ctx context.Context, arg RenameModuleScriptGuardedParams) (int64, error)
	RestoreAsset(ctx context.Context, arg RestoreAssetParams) (int64, error)
	RestoreConfigurationGroup(ctx context.Context, arg RestoreConfigurationGroupParams) (int64, error)
	RestoreDependencyGroup(ctx context.Context, arg RestoreDependencyGroupParams) (int64, error)
	RestoreGroup(ctx context.Context, arg RestoreGroupParams) (int64, error)
	RestoreIdentity(ctx context.Context, arg RestoreIdentityParams) (int64, error)
	RestorePolicyModule(ctx context.Context, id int64) (int64, error)
	...
	SetModuleOrigin(ctx context.Context, arg SetModuleOriginParams) error
	...
	SoftDeleteAsset(ctx context.Context, arg SoftDeleteAssetParams) (int64, error)
	SoftDeleteConfigurationGroup(ctx context.Context, arg SoftDeleteConfigurationGroupParams) (int64, error)
	SoftDeleteDependencyGroup(ctx context.Context, arg SoftDeleteDependencyGroupParams) (int64, error)
	SoftDeleteGroup(ctx context.Context, arg SoftDeleteGroupParams) (int64, error)
	SoftDeleteIdentity(ctx context.Context, arg SoftDeleteIdentityParams) (int64, error)
	SoftDeletePolicyModule(ctx context.Context, arg SoftDeletePolicyModuleParams) (int64, error)
	...
	UpdateRetentionSetting(ctx context.Context, arg UpdateRetentionSettingParams) (RetentionSetting, error)
	...
	UpdateVersionConditionGuarded(ctx context.Context, arg UpdateVersionConditionGuardedParams) (int64, error)
	// Draft-guarded in the statement itself, same pattern as the other
	// version mutators.
	UpdateVersionConditionsMatchMode(ctx context.Context, arg UpdateVersionConditionsMatchModeParams) (int64, error)
	// Insert-or-replace the action identified by (version_id, action_key),
	// draft-guarded the same way UpsertModuleScriptGuarded is.
	UpsertModuleActionGuarded(ctx context.Context, arg UpsertModuleActionGuardedParams) (PolicyModuleAction, error)
